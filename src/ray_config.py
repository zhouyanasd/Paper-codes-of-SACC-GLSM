ray_cluster_one = {
    ...
    'nodes':{
        ...
        'name_list':['admin', 'admin', 'admin', 'admin', 'admin'],
        'password_list':['12345678', '12345678', '12345678', '12345678', '12345678'],
        'start_commends': ['source Project/DL-NC/venv/bin/activate',
...
ray_cluster_two = {
    'head': {
        'manage_address': '192.168.111.179',
        'manage_port': 22,
    ...
    'nodes':{
        ...
        'name_list':['admin', 'admin', 'admin', 'admin', 'admin', 'admin'],
        'password_list':['12345678', '12345678', '12345678', '12345678', '12345678', '12345678'],
        'start_commends': ['source Project/DL-NC/venv/bin/activate',
